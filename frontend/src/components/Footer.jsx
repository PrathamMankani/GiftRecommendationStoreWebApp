      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">GiftRecommender</span>
            </div>
            <p className="text-gray-300 mb-4">
              Find the perfect gift for anyone with our AI-powered recommendation platform. 
              We make gift-giving easy and thoughtful.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/quiz" className="text-gray-300 hover:text-white transition-colors duration-200">Find Gifts</Link></li>
              <li><Link to="/favorites" className="text-gray-300 hover:text-white transition-colors duration-200">Favorites</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-300">
            © 2024 GiftRecommender. All rights reserved. Made with ❤️ for gift lovers.
          </p>
        </div>
      </div>
    </footer>
